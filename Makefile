...
# excuting_files.c/open_files.c excuting_files.c/dup_input_output.c excuting_files.c/dup_fd_pipe.c excuting_files.c/excute.c tools/add_ifnot_exists.c tools/clear_function.c readline_bonus.c
